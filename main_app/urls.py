...
from .import teacher_register_view
from . import hod_views, staff_views, student_views, views

urlpatterns = [
     path('login_page2/',views.login_page2,name='login_page2'),
     ...
     path('teacherregister/',teacher_register_view.teacherregister,name='teacherregister')
