...
#                 user=CustomUser.objects.create_user(email=email,first_name=fname,last_name=lname,gender=gender,password=pass1,user_type=2)
...
def login_page2(request):
    if request.method=="GET":
        ...
        return render(request, 'main_app/teacher_login.html', context)
